...
def start_screen():
    ...
    while True:
        ...
        pygame.draw.rect(screen, (0, 0, 0), play_button)     # Black Play button
        pygame.draw.rect(screen, (200, 0, 0), quit_button)   # Red Quit button
...
# Create players after start screen
