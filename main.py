...
def start_screen():
    front_screen = pygame.image.load(os.path.join(path, 'FrontScreen.png'))
...
player1 = Player(os.path.join(path, "PlayerRed.png"), 100, HEIGHT // 2, {
    "up": pygame.K_w, "down": pygame.K_s, "left": pygame.K_a, "right": pygame.K_d, "shoot": pygame.K_e
}, direction=1, boundary=boundary)
player2 = Player(os.path.join(path, "PlayerBlue.png"), WIDTH - 150, HEIGHT // 2, {
